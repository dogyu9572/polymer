...
<head>
    ...
    <script type="text/javascript">
        window.onload = function(){
			chk_pay();
			<?
			if($_SESSION["onetime"] == "OK"){	// 자동실행 한번만 세션값이 있으면
				//echo "alert(1)"; 
				echo "call_pay_form();"; 
				$_SESSION["onetime"] = "";
			}
...
<body style='display:none;'>
    <div class="wrap">
        ...
        <form name="order_info" method="post">
            ...
            <div id="skipCont" class="contents">
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 gap-2 pc-wd-2">
                                <input type="hidden" name="good_mny" value="<?=$good_mny ?>" maxlength="9" readonly />
                                <span class="txt-price"><?=number_format($good_mny) ?> 원</span>
                            </div>
                        </div>
                    </li>
                    <!-- 주문자명(buyr_name) -->
                    ...
                    <li style="display:none;">
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_mail" value="<?=$buyr_mail?>" />
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <input type="hidden" name="shop_name"       value="골든브라운" />        <!-- 사이트 이름 --> 
