<?
    ...
    $g_conf_home_dir     = $_SERVER['DOCUMENT_ROOT']."/_api/_nhnkcp/kcpcert/";	//	"[bin 디렉토리 전까지의 절대경로]";

    $g_conf_site_cd      = "AJW7A";		//AJW7A	//S6186
    
    $g_conf_web_siteid   = "";	//J23120609994

    $g_conf_ENC_KEY      = "c01fdaebf5e2cf103819daac0ba181db245fdd5443ac53c6f584d01d9e779fab";	// E66DCEB95BFBD45DF9DFAEEBCB092B5DC2EB3BF0
// 인증키 :					c01fdaebf5e2cf103819daac0ba181db245fdd5443ac53c6f584d01d9e779fab
    
    $g_conf_Ret_URL      = "http://goldenpg.hk-test.co.kr/_api/_nhnkcp/kcpcert/WEB_ENC/kcpcert_proc_req.php";
