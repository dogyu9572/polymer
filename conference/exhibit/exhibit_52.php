...
<?php $gNum="5"; $sNum="5"; $gName="Exhibition"; $sName="Exhibitor List"; ?>
			...
			<div class="row input">
				...
				<div class="cont">
					<div class="input-btn">
						...
						<button type="button" class="btn-rg outline hover2 w-13">사업자정보 조회</button>
					</div>
				</div>
			</div>
			<div class="row input">
