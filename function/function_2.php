...
<?php $gNum="3"; $sNum="3"; $gName="학회행사"; $sName="국제학술대회"; ?>
	...
	<div class="tab-container">
		<div class="tab-content">
			...
			<div class="function-scd">
				<div class="li">
					<div class="right">
						<a href="#;" class="stitle2">ChemIDP: Planning for Your Career</a>
					...
					<div class="btn">
						<a href="/conference/index.php" target="_blank" class="btn-rg">
				...
				<div class="li">
					<div class="right">
						<a href="/conference/index.php" target="_blank" class="stitle2">ChemIDP: Planning for Your Career ChemIDP: Planning for Your Career ChemIDP: Planning for Your Carrer</a>
						<ul class="bullet-gray">
							<li class="label-30">
								<span class="f-semibold">일시</span>
								<p class="f-medium t-secondary">2024.01.02 ~ 2024.02.01</p>
				...
				<div class="li">
					<div class="right">
						<a href="/conference/index.php" target="_blank" class="stitle2">ChemIDP: Planning for Your Career</a>
						<ul class="bullet-gray">
							<li class="label-30">
								<span class="f-semibold">일시</span>
								<p class="f-medium t-secondary">2024.01.02 ~ 2024.02.01</p>
