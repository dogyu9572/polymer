		...
		<dl class="search_wrap">
			...
			<dd>
				<select name="sw">
					...
					<option value='s'<?=$_GET['sw']=="s"?" selected='selected'":""?>>근무처명</option>
				...
				<table>
					...
					?>
						<tr>
							...
							<td><i class="mo_vw">상태</i><?=$arrBoardList["list"][$i]['etc_4'] == "Y"?"답변완료":"답변대기"?></td>
							<td><i class="mo_vw">이름</i><?=$arrBoardList["list"][$i]['name']?></td>
