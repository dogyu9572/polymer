...
function insertBanner(){
	...
	$sql = "insert into ".$tbl." SET 
		...
		b_device = '".$_POST['b_device']."',
		b_contents= '".$_POST['b_contents']."',		
		b_etc_1= '".$_POST['b_etc_1']."',
		b_etc_2= '".$_POST['b_etc_2']."',
		b_color_1= '".$_POST['b_color_1']."',
		b_color_2= '".$_POST['b_color_2']."',
		b_color_3= '".$_POST['b_color_3']."',
		b_color_4= '".$_POST['b_color_4']."',
...
function updateBanner($idx){
	...
	$sql = "UPDATE ".$tbl." SET 
		b_subject = '".$_POST['b_subject']."',
		b_device = '".$_POST['b_device']."',
		b_contents= '".mysqli_real_escape_string($GLOBALS['dblink'], $_POST['b_contents'])."',
		b_etc_1= '".$_POST['b_etc_1']."',
		b_etc_2= '".$_POST['b_etc_2']."',
		b_color_1= '".$_POST['b_color_1']."',
		b_color_2= '".$_POST['b_color_2']."',
...
function getBannerList($scale, $offset=0){
	...
	if($_REQUEST['b_device']!="") {
		$sql .= " and b_device='".$_REQUEST['b_device']."' ";
	}
	if($_REQUEST['sk']!="") {
		if($_REQUEST['sw']=="s") {
			$sql .= " and b_subject like '%".$_REQUEST['sk']."%' ";
		}
	}
