...
<div class="container">
    ...
    <div id="admin-content">
		...
		<div class="inbox write_tbl mo_break_write">
			...
			<div class="tit">
				<strong><font color="red"><?=$arrInfo["list"][0]['cat_name']?> 수정</font></strong>
			</div>
			<table class="admin-table-type1">
			  ...
			  <tbody>
				...
				<tr>
				  ...
				  <td>
					<div class="inputs">
						<label class="radio"><label for="is_show_y"><input type="radio" id="is_show_y" name="cat_is_show" value="Y"<?=$arrInfo["list"][0]['cat_is_show']=="Y"?" checked":""?>><i></i><font color=blue>노출함</font></label> &nbsp;
						<label class="radio"><label for="is_show_n"><input type="radio" id="is_show_n" name="cat_is_show" value="N"<?=$arrInfo["list"][0]['cat_is_show']=="N"?" checked":""?>><i></i><font color=red>노출안함</font></label>
					</div>
				  </td>
				</tr>
				<tr style="display:none;">
