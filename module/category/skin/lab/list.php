<div class="container">
    ...
    <div id="admin-content">
				...
				<div class="bdr_list tac">
					...
					?>
						<tr>
							...
							<td><?=stripslashes($arrList["list"][$i]['cat_name_eng'])?></td>
					...
					<?
						...
						echo"
						<tr height=100>
							<td colspan=6>부설연구소가 존재하지 않습니다.</td>
						</tr>
						";
					}
					?>
		...
		<div class="bdr_btm">
			<div class="btns">
				<a href="<?=$_SERVER["PHP_SELF"]?>?categoryid=<?=$arrCategoryInfo["list"][0]["categoryid"]?>&mode=write" class="btn">신규등록</a>
			</div>
		</div>
	</div>
</div>