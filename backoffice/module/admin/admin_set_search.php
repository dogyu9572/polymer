...
<div class="container">
	...
	<div class="inbox write_tbl mo_break_write">
		...
		<input type="hidden" name="returl" value="/backoffice/module/admin/admin_set_search.php">
		...
		<div class="tit">추천 검색어를 입력해 주세요 <i>*</i></div>
		<table>
			<tbody class="plus_minus plus_minus_devel">
				<tr>
					...
					<td><div class="inputs">
						...
						<br/>* 추천 검색어는 띄어쓰기 없이 '#태그1태그2'로 입력해 주세요
					</td>
				</tr>		
			</tbody>
		</table>
