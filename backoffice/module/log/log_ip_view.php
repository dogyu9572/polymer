...
$arrList = getAccessCounterTable("ip", $s_date, $e_date, $scale, $_REQUEST['offset']);
		...
		<div class="over_tbl mo_break_tbl">
			<div class="bdr_list tac">
				<table>
					...
					?>					
						<tr>
							<td><i class="mo_vw">IP Address</i><?=$arrList["list"][$i]["ip"]?></td>
