...
$arrList = getAccessCounterTable("page", $s_date, $e_date, $scale, $_REQUEST['offset']);
		...
		<div class="over_tbl mo_break_tbl">
			<div class="bdr_list tac">
				<table>
					...
					?>					
						<tr>
							<td><i class="mo_vw">주소</i><a href="<?=$arrList["list"][$i]["page"]?>" target="_blank"><?=text_cut($arrList["list"][$i]["page"],75)?></a></td>
