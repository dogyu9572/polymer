...
$arrList = getAccessCounterTable("referer", $s_date, $e_date, $scale, $_REQUEST['offset']);
		...
		<div class="over_tbl mo_break_tbl">
			<div class="bdr_list tac">
				<table>
					...
					?>					
						<tr>
							<td><i class="mo_vw">주소</i><?if($arrList["list"][$i]["referer"]=="직접입력"){echo "직접입력";}else{?><a href="<?=$arrList["list"][$i]["referer"]?>" target="_blank"><?=text_cut($arrList["list"][$i]["referer"],80)?></a><?}?></td>
