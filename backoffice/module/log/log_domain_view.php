...
$arrList = getAccessCounterTable("domain", $s_date, $e_date, $scale, $_REQUEST['offset']);
		...
		<div class="over_tbl mo_break_tbl">
			<div class="bdr_list tac">
				<table>
					...
					?>					
						<tr>
							<td><i class="mo_vw">도메인</i><?if($arrList["list"][$i]["domain"]=="직접입력"){echo "직접입력";}else{?><a href="http://<?=$arrList["list"][$i]["domain"]?>" target="_blank"><?=$arrList["list"][$i]["domain"]?></a><?}?></td>
