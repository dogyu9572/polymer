...
$arrList = getAccessCounterTable("keyword", $s_date, $e_date, $scale, $_REQUEST[offset]);
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	...
	<tr height="25" align="left">
		...
		<b><?=number_format($arrList["total"])?>개의 키워드 : <?=number_format($arrList["total_sum"])?>회</b>
		(방문자가 검색엔진을 통해서 왔을경우 && 키워드가 있을경우 에만 표시되므로 전체 방문자수와 키워드별 방문자수 합계가 동일하지 않음)
		</td>
	</tr>
	</form>
</table>
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" style="border:1px solid #dedede;">
			...
			?>
				<tr align="right">
					<td width="10%" bgcolor="#EEEEEE" align="center"><?=$arrList["list"][$i]["keyword"]?> </td>
